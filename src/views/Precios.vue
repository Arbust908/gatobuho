  ...
  <div class="bg-white">
                  ...
                  >
                    ...
                    >
                      ...
                      >
                        ...
                        <svg
                          class="flex-shrink-0 h-6 w-6 text-rose-400"
                          xmlns="http://www.w3.org/2000/svg"
                          fill="none"
                          viewBox="0 0 24 24"
                          stroke="currentColor"
    ...
    <main>
      ...
      <section class="relative" aria-labelledby="pricing-heading">
        ...
        <div
          class="
            ...
            space-y-12
            sm:px-6
            lg:max-w-7xl lg:space-y-0 lg:px-8 lg:grid lg:grid-cols-3 lg:gap-x-8
          "
        >
          <div
            class="
            ...
            <div class="flex-1">
              ...
              <ul role="list" class="mt-6 space-y-6">
                <li class="flex">
                  ...
                  <svg
                    class="flex-shrink-0 w-6 h-6 text-rose-500"
                    xmlns="http://www.w3.org/2000/svg"
                    fill="none"
                    viewBox="0 0 24 24"
                    stroke="currentColor"
                ...
                <li class="flex">
                  ...
                  <span class="ml-3 text-gray-500"
                    >48-hour support response time</span
                  >
                </li>
              </ul>
            </div>
            ...
            <div class="flex-1">
              ...
              <ul role="list" class="mt-6 space-y-6">
                ...
                <li class="flex">
                  ...
                  <span class="ml-3 text-gray-500"
                    >24-hour support response time</span
                  >
                </li>
            ...
            <div class="flex-1">
              ...
              <ul role="list" class="mt-6 space-y-6">
                ...
                <li class="flex">
                  ...
                  <span class="ml-3 text-gray-500"
                    >1-hour, dedicated support response time</span
                  >
                </li>
      ...
      <div class="relative">
        ...
        <div
          class="relative max-w-2xl mx-auto px-4 sm:px-6 lg:max-w-7xl lg:px-8"
        >
          <div
            class="
              relative
