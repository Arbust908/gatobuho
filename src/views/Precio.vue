<template>
  <div class="bg-gray-50">
    <main>
      <!-- Pricing section -->
      <div>
        <div class="relative bg-main-700">
          ...
          >
            <h1
              class="text-4xl font-bold tracking-wider font-serif sm:text-6xl"
            >
          ...
          >
            ...
            <div class="relative space-y-6 lg:space-y-0 lg:grid lg:grid-cols-3">
              ...
              >
                <div>
                  <h3 class="text-white text-sm uppercase tracking-wide">
                    Starter
                  </h3>
                  <div
                    class="
                  ...
                  >
                    <div class="mt-3 flex items-center">
                      ...
                      <div class="ml-4">
                        ...
                        <p class="text-main-300">Billed yearly ($56)</p>
                      </div>
                    </div>
                    <a
                      href="#"
              ...
              >
                ...
                <ul
                  ...
                  class="
                    border-indigo-500
                    divide-indigo-500 divide-opacity-75
                    mt-7
                    border-t
                    divide-y
                    lg:border-t-0
            ...
            <div class="w-full border-t border-gray-200 flex items-stretch">
              ...
              <div aria-hidden="true" class="pr-4 -mt-px pl-4 w-1/4">
                <div class="border-transparent py-6 border-t-2">
                  <p class="text-gray-900 text-sm font-bold text-gray-900">
                    Starter
                  </p>
                  <p class="mt-2 text-sm text-gray-500">
                    All your essential business finances, taken care of.
              ...
              <div aria-hidden="true" class="pr-4 -mt-px pl-4 w-1/4">
                <div class="border-indigo-600 py-6 border-t-2">
                  <p class="text-indigo-600 text-sm font-bold text-gray-900">
                    Scale
                  </p>
                  <p class="mt-2 text-sm text-gray-500">
                    The best financial services for your thriving business.
        ...
        >
          ...
          <div class="mt-20">
            <dl
              class="
                space-y-10
                lg:space-y-0 lg:grid lg:grid-cols-2 lg:gap-x-8 lg:gap-y-10
              "
            >
              <div>
