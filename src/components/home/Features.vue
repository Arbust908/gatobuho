<template>
  <div class="bg-gradient-to-br from-main-300 to-main-700">
    <div
      ...
      "
    >
      <h2 class="text-3xl font-extrabold text-white tracking-tight font-serif">
      ...
      >
        ...
        <div>
          ...
          <div class="mt-6">
            ...
            <p class="mt-2 text-base text-main-100">
              Guarda tus archivos en una ubicacion segura. No pierdas ningun
              archivo. Fotos, videos, documentos, etc.
            </p>
          </div>
        </div>
